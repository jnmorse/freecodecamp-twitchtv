...
class Channel extends Component {
    ...
    return(
      <section className="col-sm-12 col-md-6">
        <div className="panel panel-default">
          ...
          <footer>
            <p>
              <button type="button" className="pull-right" onClick={e => this.toggleStream(e)} href="#">
                {showText}
              </button>

              <a target="_blank" rel="noopener noreferrer" href={stream.channel.url}>
      ...
      <section className="col-xs-12 col-md-2">
        <div className="panel panel-default">
          <header className="panel-heading">
            ...
            <h4><a target="_blank" rel="noopener noreferrer" href={data.url}>{data.display_name}</a></h4>
          </header>
          <figure>
            <center>
              {this.channelImage()}
  ...
  render() {
    ...
    if (data !== undefined) {
      channel = data.stream ? this.showOnlineChannel() : this.showOfflineChannel()
    } else {
