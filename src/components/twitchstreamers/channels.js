...
class Channels extends Component {
      ...
      $.ajax({
        ...
        success: (data) => {
          ...
          if (data.stream) {
            ...
            this.setState(prevState => ({ online: [...prevState.online, newData] }))
            ...
            this.setState(prevData => ({ deleted: [...prevData.deleted, newData] }))
          } else {
            $.ajax({
              ...
              success: (channelData) => {
                ...
                this.setState(prevState => ({ offline: [...prevState.offline, newData] }))
              }
            })
          }
        },
        error: (a, b, c) => {
          if (c === 'status code 422') {
            ...
            this.setState(prevState => ({ deleted: [...prevState.deleted, newData] }))
          }
        }
      })
    })
  ...
  render() {
    const {
      display, offline, online, deleted
    } = this.state
            ...
            <ul className="nav nav-pills">
              ...
              <li id="twitchstreamers-online">
                ...
                >
                  Online
                  {' '}
                  <span className="badge">{online.length}</span>
                </button>
              </li>
              ...
              <li id="twitchstreamers-offline">
                ...
                >
                  Offline
                  {' '}
                  <span className="badge">{offline.length}</span>
                </button>
              </li>
            </ul>
          </nav>
